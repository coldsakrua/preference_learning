#!/bin/bash
#SBATCH -o logs/dapo_pref_4b_correct_mle_only_1gpu.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
run_root=${RUN_ROOT:-outputs/dapo_pref_4b_correct_mle_only_1gpu/${run_name}}
...
python train_dapo_preference.py \
  ...
  --require_gold_rationale_for_all_wrong false \
